  ...
  if(data) return (
    <>
        ...
        <nav className="my-5 flex gap-3">
            <button 
                type="button"
                className="bg-purple-400 hover:bg-purple-500 px-10 py-3 text-white text-xl font-bold cursor-pointer transation-colors"
            ...
            <Link
                ...
                className="bg-fuchsia-600 hover:bg-fuchsia-700 px-10 py-3 text-white text-xl font-bold cursor-pointer transation-colors"
            >
                Volver a Tareas
            </Link>
        </nav>
